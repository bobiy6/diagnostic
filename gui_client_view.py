...
class ClientView(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        # Title Header
        title = ctk.CTkLabel(self, text="Fiche Client & Machine", font=ctk.CTkFont(size=18, weight="bold"))
        title.grid(row=0, column=0, columnspan=2, padx=20, pady=(20, 5), sticky="w")

        subtitle = ctk.CTkLabel(self, text="Informations sur l'intervention (sans coordonnées personnelles)", font=ctk.CTkFont(size=12), text_color="gray")
        subtitle.grid(row=1, column=0, columnspan=2, padx=20, pady=(0, 20), sticky="w")

        # Fields
        ctk.CTkLabel(self, text="Nom Client / Entreprise :").grid(row=2, column=0, padx=20, pady=10, sticky="w")
        self.entry_client_name = ctk.CTkEntry(self, placeholder_text="ex. Dupont Jean / SARL Tech")
        ...
        ctk.CTkLabel(self, text="Nom du Technicien :").grid(row=4, column=0, padx=20, pady=10, sticky="w")
        self.entry_technician = ctk.CTkEntry(self, placeholder_text="ex. Alexandre Martin")
        ...
        self.option_client_type = ctk.CTkOptionMenu(self, values=["Particulier", "Professionnel"])
        ...
        self.entry_pc_brand = ctk.CTkEntry(self, placeholder_text="ex. Asus, Lenovo, HP...")
        ...
        self.entry_pc_model = ctk.CTkEntry(self, placeholder_text="ex. ZenBook 15 / ThinkPad X1")
        ...
        self.entry_serial = ctk.CTkEntry(self, placeholder_text="ex. SN-883920-AS")
        ...
        self.textbox_reason = ctk.CTkTextbox(self, height=80)
